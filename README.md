...
- [mrinjamul/simple-web-server](https://github.com/mrinjamul/simple-web-server) - A simple (static) web server (6 days ago)
...
- [termux/termux-packages](https://github.com/termux/termux-packages) ([bootstrap-2022.01.30-r1](https://github.com/termux/termux-packages/releases/tag/bootstrap-2022.01.30-r1), today) - A build system and primary set of packages for Termux.
- [mrinjamul/words-zen](https://github.com/mrinjamul/words-zen) ([v2.0.1](https://github.com/mrinjamul/words-zen/releases/tag/v2.0.1), 2 days ago) - Words as a Service.
...
- [torvalds/linux](https://github.com/torvalds/linux) - Linux kernel source tree - 125943 stars
