...
- [mrinjamul/TwinHunter](https://github.com/mrinjamul/TwinHunter) - Duplicate File Finder. (4 months ago)
...
- [mrinjamul/TwinHunter](https://github.com/mrinjamul/TwinHunter) ([v1.1.0](https://github.com/mrinjamul/TwinHunter/releases/tag/v1.1.0), 4 months ago) - Duplicate File Finder.
- [mrinjamul/cipherix](https://github.com/mrinjamul/cipherix) ([v3.1.0](https://github.com/mrinjamul/cipherix/releases/tag/v3.1.0), 4 months ago) - A command-line file encryption tool written in Go. Supports AES-256-GCM, XChaCha20-Poly1305, and X25519 public-key encryption with a unified 64 KiB chunked AEAD format. Includes a built-in keystore for managing encryption keys, shell completion, and a streaming tar library for directory encryption.

#### ⭐ Latest repositories I starred

- [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) - Free domain registration and practical DNS learning resources for everyone. - 198620 stars
...
- [torvalds/linux](https://github.com/torvalds/linux) - Linux kernel source tree - 248176 stars
