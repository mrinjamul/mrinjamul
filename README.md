...
- [goexec/goexec](https://github.com/goexec/goexec) - A single liner to execute source code programs. (6 days ago)
...
- [mrinjamul/mrinjamul-auth](https://github.com/mrinjamul/mrinjamul-auth) ([v1.1.0](https://github.com/mrinjamul/mrinjamul-auth/releases/tag/v1.1.0), 2 days ago) - A asymmetric JWT based authentication service for user management.
- [goexec/goexec](https://github.com/goexec/goexec) ([v1.0.0](https://github.com/goexec/goexec/releases/tag/v1.0.0), 6 days ago) - A single liner to execute source code programs.
...
- [torvalds/linux](https://github.com/torvalds/linux) - Linux kernel source tree - 136355 stars
