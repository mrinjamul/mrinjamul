...
- [tech-thinker/chatz](https://github.com/tech-thinker/chatz) - Slack, Google Chat, Discord and Telegram bot for sending messages/notifications. (4 months ago)
- [mrinjamul/flareship](https://github.com/mrinjamul/flareship) -  A CLI to interact with Cloudflare API and manipulate DNS records. (4 months ago)
- [tech-thinker/telepath](https://github.com/tech-thinker/telepath) - A powerful CLI tool for secure port forwarding with support for multiple jump hosts and flexible authentication. (11 months ago)

#### 🚀 Latest releases I contributed to

- [tech-thinker/chatz](https://github.com/tech-thinker/chatz) ([v1.2.3](https://github.com/tech-thinker/chatz/releases/tag/v1.2.3), 4 months ago) - Slack, Google Chat, Discord and Telegram bot for sending messages/notifications.
- [mrinjamul/flareship](https://github.com/mrinjamul/flareship) ([v2.1.0](https://github.com/mrinjamul/flareship/releases/tag/v2.1.0), 4 months ago) -  A CLI to interact with Cloudflare API and manipulate DNS records.
- [tech-thinker/telepath](https://github.com/tech-thinker/telepath) ([v1.0.2](https://github.com/tech-thinker/telepath/releases/tag/v1.0.2), 8 months ago) - A powerful CLI tool for secure port forwarding with support for multiple jump hosts and flexible authentication.
...
- [torvalds/linux](https://github.com/torvalds/linux) - Linux kernel source tree - 211758 stars
