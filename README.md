...
- [goexec/goexec](https://github.com/goexec/goexec) - A single liner to execute source code programs. (2 weeks ago)

#### 🚀 Latest releases I contributed to

- [mrinjamul/mrinjamul-auth](https://github.com/mrinjamul/mrinjamul-auth) ([v1.1.2](https://github.com/mrinjamul/mrinjamul-auth/releases/tag/v1.1.2), 6 days ago) - A asymmetric JWT based authentication service for user management.
- [goexec/goexec](https://github.com/goexec/goexec) ([v1.0.0](https://github.com/goexec/goexec/releases/tag/v1.0.0), 2 weeks ago) - A single liner to execute source code programs.
...
- [torvalds/linux](https://github.com/torvalds/linux) - Linux kernel source tree - 136881 stars
